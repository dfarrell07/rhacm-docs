...
* RHOCP on IBM Cloud (RHOIC) (tech preview)
* Microsoft Azure Red Hat OpenShift (ARO)
* Red Hat OpenShift Service on AWS (ROSA)
* RHOCP on bare metal (tech preview)
* RHOCP on VMware vSphere
* RHOCP on Red Hat OpenStack Platform (RHOSP)
* RHOCP on IBM Power Systems (tech preview)
* Red Hat OpenShift Kubernetes Engine

Not listed on support matrix but should be?
